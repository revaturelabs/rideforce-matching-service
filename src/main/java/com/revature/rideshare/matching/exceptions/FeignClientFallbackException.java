...
/** 
 * This class represents the exception that will be thrown when 
 * Hystrix triggers the fallback implementation of a FeignClient and 
 * no reasonable data can be returned from the fallback. 
 */
