...
public class ResponseErrorBeanTest {
	...
	/**
	 * Tests setMessage sets the message correctly, and that the get function gets
	...
	/**
	 * Tests setDetails sets the details correctly, and that the get function gets
	 * that details correctly.
	 */
	@Test
	...
	/**
	 * Tests withDetails sets the details correctly, and that the get function gets
	 * that details correctly.
	 */
	@Test
	...
	/**
	 * Tests that the toResponseEntity method returns the appropriate object.
	 */
	@Test
	...
	/**
	 * Tests that an empty message from a constructor throws a violation with an
	 * empty exception.
	 */
	@Test
	...
	/**
	 * Tests that there are 2 violations if the details are null and message are
	 * null.
	 */
	@Test
	 ...
	 * computed by the {@code LocalValidatorFactoryBean}, doesn't equal the expected
