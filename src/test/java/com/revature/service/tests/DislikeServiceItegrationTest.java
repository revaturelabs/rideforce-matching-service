...
/**
 * This Class, DislikeServiceItegrationTest, is used to test the dislikeService
 * to ensure code stability throughout code development.
 */
...
public class DislikeServiceItegrationTest {
	...
	/**
	 * Tests the get method of the dislike service. getDislikes should return all
	 * dislikes in the database with a user id matching the id passed.
	 */
	@Test
	...
	/**
	 * Test the delete function of the Dislike Service. The dislike with the
	 * matching id's passed (userId and AffectedId) should be deleted from the
	 * database.
	 */
	@Test
